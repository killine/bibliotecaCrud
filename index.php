...
<body>
 ...
 ?>
                                         <td>
                                            ...
                                            <a href="form_atualiza_livro.php?codLi= <?php echo "{$linha['codLi']}"; ?>" class ="btn btn-primary"> Atualizar </a>
                                                    &nbsp;&nbsp;
                                             <a href="delete_livro.php?codLi= <?php echo "{$linha['codLi']}"; ?>" class ="btn btn-danger"> Deletar </a>
