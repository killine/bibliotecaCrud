            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        ...
                        $consulta = "SELECT * FROM livros WHERE codLi = '$codLi'";
        ...
        <div class="content mt-3">
            <div class="col-sm-12">
                <div class="card-body card-block">
                    <form action="atualiza_livro.php?codLi=<?php echo $codLi;?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
...
class="form-control">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="pag" value = " <?php echo $linha['pag']?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
